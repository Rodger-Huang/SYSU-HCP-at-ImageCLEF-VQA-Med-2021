...
class Grayscale(object):
    def __call__(self, sample):
        sample['image'] = sample['image'].convert('L').convert('RGB')
...
class colorjitter_sample(object):
    def __init__(self, parameters=(0.2, 0.2, 0.2, 0.05), prob=0.5):
    ...
    def __call__(self, sample):
        ...
        if random.random() < self.prob:
            ...
            brightness, contrast, saturation, hue = self.parameters
