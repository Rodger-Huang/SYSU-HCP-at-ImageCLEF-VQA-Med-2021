...
from model.resnest.resnest import resnest50, resnest101


class resnest50HGap(nn.Module):
    def __init__(self, pretrained=True, num_classes=330):
        super(resnest50HGap, self).__init__()
        self.resnest50 = resnest50(pretrained=pretrained)
        self.model_list = list(self.resnest50.children())
...
if __name__ == '__main__':
    model = resnest50HGap(pretrained=True)
